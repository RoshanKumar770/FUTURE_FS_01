...
function Contact() {
  ...
  return (
    <section id="contact" className="section-fade" style={{ padding: "7rem 2.5rem" }}>
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        ...
        {sent ? (
          <div style={{
            border: "1px solid var(--accent)", padding: "2rem",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <button
              ...
              style={{
                ...
                padding: "0.9rem 2rem", border: "none", cursor: loading ? "wait" : "none",
