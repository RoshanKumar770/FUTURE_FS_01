const PROJECTS = [
  {
    ...
    tags: ["Docker", "Flask", "Nginx", "PostgreSQL", "Redis"],
    link: "#",
  },
  {
    num: "02",
    ...
    tags: ["GitHub Actions", "Docker", "CI/CD", "Node.js", "Python"],
    link: "#",
  },
  {
    num: "03",
    ...
    tags: ["Kubernetes", "Microservices", "Docker", "AWS"],
    link: "#",
  },
  {
    num: "04",
    ...
    tags: ["WordPress", "AWS EC2", "Nginx", "S3", "Linux"],
    link: "#",
  },
];
...
function Projects() {
  return (
    <section id="projects" className="section-fade" style={{ padding: "7rem 2.5rem" }}>
          ...
          {PROJECTS.map(({ num, title, desc, tags, link }) => (
            <div key={num}
              style={{
                ...
                gap: "2rem", alignItems: "start", transition: "background 0.2s",
                cursor: "pointer",
              }}
            ...
            >
              <span style={{
                ...
                fontSize: "2.5rem", color: "var(--border)", lineHeight: 1,
              }}>{num}</span>

              <div>
                <h3 style={{
                  fontFamily: "var(--font-display)", fontWeight: 700,
                  fontSize: "1.3rem", marginBottom: "0.75rem", color: "var(--text)",
                }}>{title}</h3>
